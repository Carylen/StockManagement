...
export const ALL_NAV_ITEMS: NavItem[] = [
  ...
  { href: "/supplier/plant-mapping", tKey: "supplierPlantMapping", icon: MapPin,  show: (c) => c.can("can_upload_readiness") },
  { href: "/admin/upload",      tKey: "uploadReadiness",   icon: Upload,          show: (c) => c.can("can_upload_admin_stock") },
