  ...
  return (
    <div
      ...
      className={clsx(
        ...
        dragging ? "border-primary bg-primary-soft" : "border-primary/40 bg-surface hover:bg-primary-soft/30"
      )}
    >
      <input
        ref={inputRef}
      ...
      <p className="text-lg font-bold text-ink mb-1">
        {loading ? t("processing") : t("drag")}
      </p>
      <p className="text-sm text-ink-2 mb-4">
        Format: <code className="font-mono bg-surface-alt px-1.5 py-0.5 rounded text-xs">READYNESS_VHS_KPP_AGMR_*.xlsx</code> · {t("maxSize")}
      </p>
      {!loading && (
        <button
          type="button"
